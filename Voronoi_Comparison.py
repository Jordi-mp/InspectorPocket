...
voronoi_non_binding = Voronoi(non_binding_sites)

def calculate_proximity_non_binding(voronoi_non_binding, non_binding_sites):
...
proximity_non_binding = calculate_proximity_non_binding(voronoi_non_binding, non_binding_sites)
